 ...
 * @see cl.aiep.carrito.dao.Usuario
...
public class UsuarioHome
{
	...
	public Usuario findById(java.lang.Long id)
	{
		...
		try
		{
			Usuario instance = (Usuario) sessionFactory.getCurrentSession().get("cl.aiep.carrito.dao.Usuario", id);
			if (instance == null)
			{
	...
	public List findByExample(Usuario instance)
	{
		...
		try
		{
			List results = sessionFactory.getCurrentSession().createCriteria("cl.aiep.carrito.dao.Usuario")
